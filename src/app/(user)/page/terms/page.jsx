...
function TermsPage() {
  return (
    <div className="my-8">
      {/* Terms */}
      <div className="flex flex-col items-cente justify-center container mx-auto size-full xl:max-w-7xl bg-[#FEF8FA] sm:px-6 md:p-6 sm:rounded-3xl md:rounded-t-[40px]">
        ...
        <div className="flex flex-col md:gap-8 bg-white max-md:ring-4 md:ring-8 ring-black/5  max-md:rounded-[20px] md:rounded-[40px] p-6">
