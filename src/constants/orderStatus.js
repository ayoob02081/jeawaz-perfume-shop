...
export const adminStatusConfig = [
  ...
  },
  {
    ...
    des: "ثبت سفارش",
    color: "bg-blue/15",
    textColor: "text-blue border-blue",
    icon: ClockIcon,
    solidIcon: ClockSolidIcon,
  },
  {
    ...
    textColor: "text-violet-600 border-violet-600",
    icon: CheckCircleIcon,
    solidIcon: CheckCircleSolidIcon,
  },
  {
    ...
    des: "چاپ",
    color: "bg-green/10",
    textColor: "text-green border-green",
    icon: PrinterIcon,
  ...
  },
  {
    ...
    des: "چاپ شدن",
    color: "bg-warning/15",
    textColor: "text-orange border-orange",
  ...
  },
  {
    ...
    textColor: "text-stroke-800 border-stroke-800",
