...
function SupportBox() {
  return (
    <section className="flex max-md:flex-col max-md:items-start md:items-center justify-between max-md:gap-8 bg-primary p-6 md:px-10 md:py-12 rounded-xl sm:rounded-2xl md:rounded-4xl w-full ">
      ...
      >
        <div className="flex items-center justify-center ring-4 ring-white/25 bg-white rounded-full size-6 md:size-8 lg:size-12 duration-200">
          <AppImage
            ...
            width="size-3 md:size-4 lg:size-6"
            sizes="10vw"
          />
        </div>
